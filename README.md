...
| File | Description |
| :--- | :--- |
| [📄 GLOBAL_SIGMA_RESEARCH_EDITION.pdf](./GLOBAL_SIGMA_RESEARCH_EDITION.pdf) | The complete framework (P1-P12, Risk Tiers, Audit Methodology) |
| [🛠️ Self Assessment Tool](./GLOBAL_SIGMA_PUBLIC_STANDARD_Annex_A_Self_Assessment_Tool.txt) | Editable matrix for self-evaluation against the 12 principles |
| [📋 Executive Summary (EN/ES)](./GLOBAL_SIGMA_PUBLIC_STANDARD_Executive_Summary_EN_ES.pdf) | Bilingual 1-pager for decision-makers |
| [🔗 Immutability Patterns Guide](./GLOBAL_SIGMA_PUBLIC_STANDARD_Immutability_Pattern_Guide.pdf) | Technical patterns for forensic-proof certification (Annex G) |
...
- **Scientific Authorship:** Licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) (Attribution required to **Dr. Paula Melissa Alfaro Montero** — ORCID: [0009-0004-2849-5794](https://orcid.org/0009-0004-2849-5794)).
- **Governance:** Managed by the independent **Guardian Foundation** (The Sunset Model).
- **Commercial Tooling:** Reserved IP for high-assurance auditing services and intervention-ready modularity.
